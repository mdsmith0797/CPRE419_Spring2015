/* Generated by Streams Studio: April 16, 2015 12:30:37 AM EDT */
package application;
 ...
 */
@PrimitiveOperator(name="task4b", namespace="application",
description="Java Operator task4b")
...
public class task4b extends AbstractOperator {
	
	// reserve 4 global variables
	// Children stores the room each child visited during last 5 min in time order
	...
	public Map<String, LinkedHashSet<String>> Children; 	
	...
	public synchronized void initialize(OperatorContext context)
        ...
        Children = new HashMap<String, LinkedHashSet<String>>();
		...
		while ((line = br.readLine()) != null) {
			...
			Children.put(lines[0], new LinkedHashSet<String>());
		}
    ...
    public final void process(StreamingInput<Tuple> inputStream, Tuple tuple)
		...
		// add the new visited room to each child 
    	LinkedHashSet<String> a = Children.get(tuple.getString("ChildID"));
    	a.add(tuple.getString("ToRoom"));    	
    	Children.put(tuple.getString("ChildID"),a);
    	    	
    	// output every 5min (300000 milliseconds)
    	if (currenttime>starttime+300000)
    	{
    	starttime=starttime+300000;    	
    	  	
    	// iterate through each child
    	for (Map.Entry<String, LinkedHashSet<String>> entry : Children.entrySet())
    	{
        ...
        LinkedHashSet<String> x = entry.getValue();
		...
		// re-set the child info, remove every but the current room for each child
    	for (Map.Entry<String, LinkedHashSet<String>> entry : Children.entrySet())
    	{
    		LinkedHashSet<String> x = entry.getValue();
    		if (x.size()>0){
    		LinkedHashSet<String> y = new LinkedHashSet<String>();
    		String currentroom = (String)x.toArray()[x.size()-1];
    		y.add(currentroom);
    		Children.put(entry.getKey(), y);
    		}
    	}
    	}
    }
