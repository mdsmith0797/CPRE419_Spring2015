REGISTER '/home/shuowang/GROWTH.jar';
...
top_companies1 = limit order_growth1 5;
top_companies2 = limit order_growth2 5;

--Store the result
STORE top_companies1 INTO '/scr/shuowang/lab7/exp1/output1/';
STORE top_companies2 INTO '/scr/shuowang/lab7/exp1/output2/';
