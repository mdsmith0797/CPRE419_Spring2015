...
input_ip_trace = LOAD '/class/s15419x/lab6/ip_trace' USING PigStorage(' ') AS (time:chararray,
...
input_raw_block = LOAD '/class/s15419x/lab6/raw_block' USING PigStorage(' ') AS 
...
-- Store the output
STORE firewall INTO '/scr/shuowang/lab6/exp3/firewall/';
...
-- Store the output
STORE sort_result INTO '/scr/shuowang/lab6/exp3/output/';
